...
export const FETCH_APPROVED_TOPIC = 'FETCH_APPROVED_TOPIC';
export const FETCH_APPROVED_TOPIC_SUCCESS = 'FETCH_APPROVED_TOPIC_SUCCESS';
export const FETCH_APPROVED_TOPIC_FAILURE = 'FETCH_APPROVED_TOPIC_FAILURE';


export const FETCH_REJECTED_TOPIC = 'FETCH_REJECTED_TOPIC';
export const FETCH_REJECTED_TOPIC_SUCCESS = 'FETCH_REJECTED_TOPIC_SUCCESS';
export const FETCH_REJECTED_TOPIC_FAILURE = 'FETCH_REJECTED_TOPIC_FAILURE';



export const FETCH_ALL_TOPIC = 'FETCH_ALL_TOPIC';
export const FETCH_ALL_TOPIC_SUCCESS = 'FETCH_ALL_TOPIC_SUCCESS';
export const FETCH_ALL_TOPIC_FAILURE = 'FETCH_ALL_TOPIC_FAILURE';